...
@RequestMapping(value = "/api/student/question-answers")
public class QuestionAnswerController extends BaseApiController {
     ...
     */
    @PostMapping
    public RestResponse<PageInfo<QuestionPageStudentResponseVM>> listQuestionAnswers(@RequestBody QuestionPageStudentRequestVM model) {
     ...
     */
    @GetMapping("/{id}")
    public RestResponse<QuestionAnswerVM> getQuestionAnswer(@PathVariable Integer id) {
